#undef PROTOTYPESURVIVALCPP_API
#undef PROTOTYPESURVIVALCPP_VTABLE
...
#define PROTOTYPESURVIVALCPP_VTABLE DLLEXPORT_VTABLE
#define PROTOTYPESURVIVALCPP_API DLLEXPORT
